...
package enum PreferencesStore {
    package static func opened() -> any PinnedAppStorePort & StartPinStorePort & StartGroupStorePort & ApplicationUsageStorePort & PresetStorePort & QuitExclusionStorePort & DockSnapshotStorePort {
