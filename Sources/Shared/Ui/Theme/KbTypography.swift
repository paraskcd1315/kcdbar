...
enum KbTypography {
    static let entryTitle = Font.system(size: 12, weight: .regular)
    static let entryTitleActive = Font.system(size: 12, weight: .medium)
    static let clockTime = Font.system(size: 12, weight: .medium)
    static let clockDate = Font.system(size: 10, weight: .regular)
